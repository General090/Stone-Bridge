...
const heroImage = "https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=1600&q=85";
      ...
      <section className="bg-[#f4f1ea] px-5 py-16 sm:px-8 lg:px-12 lg:py-20">
        <div className="mx-auto grid max-w-350 gap-7 lg:grid-cols-3">
          {[
            ...
            <article key={name} className="rounded-xl border border-[#d6d1c7] bg-white p-5 shadow-sm">
              <div className="grid grid-cols-[128px_1fr] gap-5">
                ...
                <div>
                  ...
                  <p className="mt-3 font-bold text-[#c38b24]">{role}</p>
